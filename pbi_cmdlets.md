...
### download all pbix from single workspace (BKP prefix)
```powershell
...
$dataset_workspace_name = '___prd_tpg_bi'          # chose datasets
$report_workspace_name = 'Printed.com'             # chose thin reports
